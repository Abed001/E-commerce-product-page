...
export default function Navbar({ onCartClick }) {
    ...
    return (
        ...
        <div className=' relative p-4 flex justify-between items-center max-w-[1200px] lg:py-[1rem] mx-auto border-b-2 lg:h-[83px] '>
            ...
            <div className='min-h-[full] flex flex-row flex-1 w-full gap-x-10 items-center'>
                ...
                <div className="flex gap-7 max-[900px]:hidden">
                    <p className="hover:-mb-1 hover:border-b-4 hover:border-orange-500 py-6 cursor-pointer transition duration-300">
                        Collections
                    </p>
                    <p className="hover:-mb-1 hover:border-b-4 hover:border-orange-500 py-6 cursor-pointer transition duration-300">
                        Men
