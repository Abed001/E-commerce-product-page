    ...
    return (
        ...
        <div className='relative p-4 flex justify-between items-center  max-w-[1200px] lg:py-[1rem]  mx-auto border-b-2 '>
            ...
            <div className=' flex flex-row flex-1 w-full gap-x-10 items-center'>
                ...
                <ul className='hidden cursor-pointer text-gray-500  items-center gap-x-5 lg:flex lg:flex-row lg:min-w-[500px] '>
                    <li>Collections</li>
                    <li>Men</li>
                    <li>Women</li>
                    <li>About</li>
            ...
            <div className=' absolute flex  top-0 left-0 p-30 min-w-[350px]'>
                {open && (
            ...
            <div className=' flex gap-x-10 justify-evenly items-center'>
